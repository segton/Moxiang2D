...
set "OBJ_DIR=D:\Dev\Moxiang2D\build-web\raylib-obj"
set "LIB_DIR=D:\Dev\Moxiang2D\build-web\lib"
set "OUT_LIB=D:\Dev\Moxiang2D\build-web\lib\libraylib_web.a"
...
if not exist "%OUT_LIB%" (
    echo ERROR: The library was not created.
    goto build_failed
)

echo.
echo Checking that rmodels is included...
echo.

emar t "%OUT_LIB%" | findstr /i "rmodels.o"
